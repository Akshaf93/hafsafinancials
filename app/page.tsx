...
export default function Home() {
  return (
    <main className="w-full h-screen overflow-y-auto snap-y snap-mandatory">
        ...
        {/* SECTION 2: SERVICES */}
        <section className="min-h-screen w-full snap-start relative flex flex-col justify-center pt-20">
            <ServicesOverview />
        </section>
        ...
        <section className="min-h-screen w-full snap-start relative flex flex-col justify-between pt-20">
            {/* Top Spacer */}
            <div />
