...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050505] text-[#FDFCF0] pt-20 pb-10 border-t border-[#FDFCF0]/10 relative z-50">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight">
              Hafsa<span className="text-[#E5D095]">Advisors and Solutions (LLP)</span>
            </h2>
          </div>
          ...
          <div className="flex gap-4 pt-2">
            <a href="https://www.linkedin.com/company/hafsa-financial-advisory-and-artificial-intelligence-sevices-llc/" target="_blank" rel="noopener noreferrer" className="text-[#FDFCF0]/60 hover:text-[#E5D095] transition-colors">
            ...
            <a href="https://wa.me/923112461486" target="_blank" rel="noopener noreferrer" className="text-[#FDFCF0]/60 hover:text-[#E5D095] transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 text-center md:text-left flex flex-col md:flex-row justify-between text-xs text-[#FDFCF0]/40">
        <p>&copy; 2026 Hafsa Advisors and Solutions (LLP). All rights reserved.</p>
