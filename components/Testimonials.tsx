  ...
  return (
    <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="space-y-4 text-base md:text-lg font-light leading-relaxed text-[#FDFCF0]/80">
                   <p>
                     Hafsa Advisors and Solutions (LLP) delivers hands-on IFRS advisory, financial architecture, internal audit, and control solutions grounded in real engagements — not theory.
                   </p>
