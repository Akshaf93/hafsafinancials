  ...
  return (
    <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="relative">
          <span className="text-8xl text-[#D4AF37] absolute -top-10 -left-10 opacity-20 font-serif">"</span>
          ...
          <div>
            <h4 className="font-bold text-[#D4AF37] text-lg">CFO, Mid-Market Logistics Firm</h4>
